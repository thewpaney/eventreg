...
** Technical things
*** To write
**** Sign up specific user for specific workshop array
...
*** To revisit
**** Downloading workshops from Google Drive
***** Make sure dependencies don't break in the future
**** student#force and teacher#force
***** Move these out of model?
**** student#auto and teacher#auto
**** student#finished_with_registration? and teacher#finished_with_registration?
***** Essentially just `return sessions_needed.empty?`
***** Can we delete this? I think we can
*** Views
**** Get rid of highlighting the workshop from the list once it's been claimed
